        ...
        <motion.div className="modal-overlay">
          ...
          <div className="modal-wrapper">
            <motion.div
              ...
              transition={{
                opacity: { duration: 0.3 }, // Opacity change with 0.3s duration
                scale: { duration: 0.3 }, // Scale change with 0.3s duration
                filter: { duration: 0.1 },
                transform: {
                  duration: 0.2,
                },
              }}
              className="min-w-[500px] min-h-[400px] pt-[80px] bg-white rounded-[20px] relative"
            >
              <span
